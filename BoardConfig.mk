...
# headers
TARGET_SPECIFIC_HEADER_PATH := device/amazon/austin/include

# inherit from the proprietary version
-include vendor/amazon/austin/BoardConfigVendor.mk
...
TARGET_USE_BUILT_BOOTIMAGE := device/amazon/austin/boot.img
...
#TARGET_KERNEL_SOURCE := kernel/amazon/austin
#TARGET_KERNEL_CONFIG := austin_cyanogenmod_defconfig
#TARGET_KERNEL_VARIANT_CONFIG := austin_cyanogenmod_defconfig
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/amazon/austin/bluetooth

# Graphics
BOARD_EGL_CFG := device/amazon/austin/egl.cfg
...
TARGET_PREBUILT_RECOVERY_KERNEL := device/amazon/austin/kernel
#TARGET_RECOVERY_INITRC := device/amazon/austin/recovery/root/init.rc
TARGET_RECOVERY_FSTAB := device/amazon/austin/recovery/root/recovery.fstab
...
TW_AMONET := true
TW_AMONET_MICROLOADER_SRC := device/amazon/austin/recovery/microloader.cpp
